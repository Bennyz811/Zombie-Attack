...
class Game {
  ...
  startScreen(){
    ...
    this.ctx.font = "30px arial";
    this.ctx.fillStyle = "#c43736";
    this.ctx.fillText("Use arrow keys to move", 280, 150);
    this.ctx.font = "30px arial";
    this.ctx.fillStyle = "#c43736";
    this.ctx.fillText("HOLD space bar to shoot", 290, 150);
    this.ctx.font = "30px arial";
    this.ctx.fillStyle = "#c43736";
    this.ctx.fillText("Press 'p' to PAUSE", 295, 150);
    this.ctx.font = "30px arial";
    this.ctx.fillStyle = "#c43736";
    this.ctx.fillText("Press 'r' to RESTART", 300, 150);
    this.ctx.font = '30px arial';
    this.ctx.fillStyle = '#c43736';
